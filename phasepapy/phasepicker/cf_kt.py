...
class Kurtosis():
    ...
    def _statistics(self):
        ...
        # Tricky: Construct a big window of length len(a)-nsta.
        # Now move this window nsta points, i.e. the window "sees"
        # every point in a at least once.
